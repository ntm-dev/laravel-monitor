...
return [
    ...
    'nav' => [
        ...
        'sign_out' => 'Đăng xuất',
        'live_refresh' => 'Trực tiếp · làm mới mỗi :seconds :unit',
        'refresh_in' => 'Làm mới sau :seconds :unit',
    ],
    ...
    'header' => [
        ...
        'invalid_date' => 'Giá trị không hợp lệ.',
    ...
    'settings' => [
        ...
        'recorder_detail_response_body' => 'Ghi lại nội dung response',
    ...
    'common' => [
        ...
        'mailer' => 'Mailer',
        'mailable' => 'Mailable',
        'mail_body' => 'Nội dung Mail',
        'mail_body_not_recorded' => 'Nội dung mail này chưa được ghi lại — bật "Ghi lại nội dung" cho Mail trong Settings để ghi lại cho các lần gửi sau.',
        'mail_body_format_html' => 'HTML',
        'mail_body_format_text' => 'Văn bản thuần',
        'model' => 'Model',
        'relation' => 'Relation',
        ...
        'dispatched' => 'Đã dispatch',
        'pending' => 'Chờ xử lý',
        'processed' => 'Đã xử lý',
        'processing' => 'Đang xử lý',
        'queued' => 'Đang chờ',
        'total_hint' => 'Tổng số lần job được thêm vào queue — tính cả dispatch ban đầu và các lần được released lại vào queue.',
        'dispatched_hint' => 'Số lần job được dispatch lần đầu — không tính các lần được released lại vào queue.',
        'pending_hint' => 'Job còn nằm trong queue, chưa từng được lấy ra chạy — gồm job mới dispatch và job đã released nhưng chưa chạy lại.',
        'processing_hint' => 'Số lần thử của job đang chạy ngay lúc này — một lần thử rời khỏi số đếm này ngay khi có kết quả (processed, released hoặc failed).',
        'processed_hint' => 'Số lần job chạy thành công — kể cả sau khi bị released rồi chạy lại thành công.',
        'released_hint' => 'Số lần job gặp lỗi (exception được catch) và bị đưa lại vào queue để thử lại.',
        'failed_hint' => 'Số lần job thất bại hẳn vì đã vượt quá số lần retry cho phép.',
        'ok_status' => '1/2/3XX',
        'client_error' => '4XX',
        'server_error' => '5XX',
        ...
        'update_failed' => 'Cập nhật thất bại — sẽ tự động thử lại',
        'clear' => 'Xoá',
        'search' => 'Tìm kiếm',
        ...
        'routes' => 'Route',
        'top_routes' => 'Route được gọi nhiều nhất',
        'slowest_routes' => 'Route chậm nhất',
        'no_routes_recorded_in_period' => 'Không có route nào được ghi nhận trong khoảng thời gian này.',
        ...
        'job_run_count' => 'Lần chạy Job',
        'notification_count' => 'Thông báo',
        'job_count' => 'Job',
        'exception_count' => 'Ngoại lệ',
        'send_count' => 'Lượt gửi',
        'query_count' => 'Truy vấn',
        'call_count' => 'Lượt gọi',
    ...
    'issue' => [
        'manage' => 'Quản lý',
        'priority' => 'Độ ưu tiên',
        'priority_none' => 'Không có độ ưu tiên',
        'priority_low' => 'Thấp',
