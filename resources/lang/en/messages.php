...
return [
    ...
    'settings' => [
        ...
        'recorder_detail_response_body' => 'Record response body',
    ...
    'common' => [
        ...
        'mailable' => 'Mailable',
        'mail_body' => 'Mail Body',
        'mail_body_not_recorded' => 'This mail\'s body was not recorded — turn on "Record body" for Mail in Settings to capture it on future sends.',
        'mail_body_format_html' => 'HTML',
        'mail_body_format_text' => 'Plain Text',
        'model' => 'Model',
        'relation' => 'Relation',
        'record_id' => 'Record ID',
        'method' => 'Method',
        ...
        'queued' => 'Queued',
        'total_hint' => 'Every time this job entered the queue — initial dispatches plus retries re-added by a release.',
        'dispatched_hint' => 'How many times this job was dispatched initially — not counting retries re-added by a release.',
        'pending_hint' => 'Still sitting in the queue, never picked up yet — a fresh dispatch or a released retry waiting for its next attempt.',
        'processing_hint' => 'How many attempts of this job are running right now — an attempt leaves this count the moment it resolves to processed, released, or failed.',
        'processed_hint' => 'How many times this job completed successfully — including after being released and retried.',
        'released_hint' => 'How many times this job threw a caught exception and was put back on the queue to retry.',
        'failed_hint' => 'How many times this job failed permanently after exceeding its retry limit.',
        'ok_status' => '1/2/3XX',
        'client_error' => '4XX',
        'server_error' => '5XX',
        ...
        'no_routes_recorded_in_period' => 'No routes recorded in this period.',
