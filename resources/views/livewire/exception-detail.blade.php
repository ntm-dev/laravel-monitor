<div wire:poll.{{ $refresh }}s>
    @if (! $exists)
        <x-monitor::card class="p-10 text-center">
            ...
            <a href="{{ route('monitor.dashboard', ['tab' => 'exceptions'] + $range) }}" class="mt-4 inline-block text-sm text-blue-600 dark:text-purple-400 hover:underline">{{ __('monitor::messages.exception.back_to_exceptions') }}</a>
        </x-monitor::card>
    @else
                ...
                <div class="flex flex-col gap-3 p-4 md:p-5"
                    ...
                    <div class="flex justify-between gap-2 max-md:flex-col md:items-center">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div
                                class="flex h-6 w-fit shrink-0 items-center divide-x divide-neutral-300/60 dark:divide-neutral-600/60 rounded-md bg-neutral-200 dark:bg-neutral-800 shadow-neu-inset dark:shadow-neu-dark-inset font-mono text-xs">
