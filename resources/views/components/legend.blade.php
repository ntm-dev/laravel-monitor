...
@props(['label', 'dot', 'value', 'color' => 'text-neutral-900', 'size' => 'lg'])
<div class="text-right">
    <p class="flex items-center justify-end gap-1.5 font-mono {{ $size === 'lg' ? 'text-xs' : 'text-[10px]' }} uppercase tracking-tight text-neutral-500">
