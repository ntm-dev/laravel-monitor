...
final class Location
{
    ...
    public function __construct()
    {
        ...
        $this->artisanPath = $this->joinPaths($this->basePath, 'artisan');
        $this->vendorPath = $this->joinPaths($this->basePath, 'vendor');
        $this->monitorPath = $this->joinPaths($this->vendorPath, 'ntm-dev', 'laravel-monitor');
        $this->frameworkPath = $this->joinPaths($this->vendorPath, 'laravel', 'framework');
        $this->publicIndexPath = $this->joinPaths(public_path(), 'index.php');
    }
    ...
    private function isInternalFile(string $file): bool
    {
        return str_starts_with($file, $this->frameworkPath) ||
            str_starts_with($file, $this->monitorPath) ||
            $file === $this->artisanPath ||
            $file === $this->publicIndexPath;
    }
