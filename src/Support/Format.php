...
class Format
{
    ...
    {
        return match (true) {
            $status >= 500 => 'bg-neutral-200 text-rose-600 shadow-neu-inset dark:bg-neutral-800 dark:text-rose-400 dark:shadow-neu-dark-inset',
            $status >= 400 => 'bg-neutral-200 text-amber-600 shadow-neu-inset dark:bg-neutral-800 dark:text-amber-400 dark:shadow-neu-dark-inset',
